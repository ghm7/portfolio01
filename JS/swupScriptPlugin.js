(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root["SwupScriptsPlugin"] = factory();
})(window, function () {
        ...
        var ScriptsPlugin = (function (_Plugin) {
          ...
          function ScriptsPlugin(options) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (
                ScriptsPlugin.__proto__ || Object.getPrototypeOf(ScriptsPlugin)
              ).call(this)
            );
            ...
            _this.runScripts = function () {
              var scope =
                _this.options.head && _this.options.body
                  ? document
                  : _this.options.head
                  ? document.head
                  : document.body;

              var selector = _this.options.optin
            ...
            _this.runScript = function (originalElement) {
              ...
              try {
                for (
                  var _iterator = arrayify(originalElement.attributes)[
                      Symbol.iterator
                    ](),
                    _step;
